          ...
          <div className="relative">
            ...
            <div className="relative aspect-[4/3] bg-[#002B5C] overflow-hidden">
              ...
              <div
                ...
                style={{ backgroundImage: "url(/images/team/define-us.webp)" }}
              />
              {/* Stats overlay */}
